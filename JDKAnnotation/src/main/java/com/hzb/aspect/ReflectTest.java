...
//		Object fieldValueByName = reflectTest.getFieldValueByName("name", user);
//		System.out.println(fieldValueByName);
		
//		reflectTest.getFiledName(user);
//		reflectTest.getFiledsInfo(user);
		reflectTest.getFiledValues(user);
	}
}
