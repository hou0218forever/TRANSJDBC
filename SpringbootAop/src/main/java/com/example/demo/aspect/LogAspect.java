...
/**
* @author HouZhiBo
* @version 创建时间：2018年10月30日 下午2:56:31
* @ClassName 类名称
* @Description 类描述
*/
/**
...
import com.example.demo.util.UserAgentUtils;
...
public class LogAspect {
	 ...
	 * Service层切点
	 */
	@Pointcut("@annotation(com.example.demo.logs.ServiceLogs)")
	 ...
	 * Controller层切点
	 */
	@Pointcut("@annotation(com.example.demo.logs.ControllerLogs)")
	...
	public void doBefore(JoinPoint joinPoint) {
		try {
			...
			sb.append("ContentType   :  ")
					.append(("".equals(request.getContentType()) || request.getContentType() == null) ? "FROM"
							: request.getContentType())
					.append("\n");
			sb.append("RequestParams :  ").append(("".equals(decode) || decode == null) ? methodParam : methodParamMap)
					.append("\n");
			...
			sb.append("ServerAddr    :  ")
					.append(request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort())
					.append("\n");
